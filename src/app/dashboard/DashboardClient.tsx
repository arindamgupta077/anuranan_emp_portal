...
export default function DashboardClient({ user, stats }: DashboardClientProps) {
  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-8 px-4 md:px-0">
      ...
      {/* Quick Actions Section with Premium Design - Mobile Optimized */}
      <div className="bg-white rounded-2xl shadow-xl p-4 md:p-8 border border-gray-100">
        <div className="flex flex-col md:flex-row items-start md:items-center md:justify-between mb-4 md:mb-6">
          <div>
            ...
            <p className="text-xs md:text-sm text-gray-600 mt-1">Frequently used features at your fingertips</p>
          </div>
        </div>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
          {/* Regular User Actions - Mobile Optimized */}
          <Link href="/tasks" className="group touch-target">
            <div className="relative overflow-hidden rounded-xl p-4 md:p-6 bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">
              <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
              <CheckSquare className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 relative z-10" />
              <h3 className="text-white font-semibold text-base md:text-lg mb-1 relative z-10">My Tasks</h3>
              <p className="text-blue-100 text-xs md:text-sm relative z-10">View and manage assigned tasks</p>
              <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-white absolute bottom-3 md:bottom-4 right-3 md:right-4 group-hover:translate-x-1 transition-transform duration-300" />
            </div>
          </Link>

          <Link href="/self-tasks" className="group touch-target">
            <div className="relative overflow-hidden rounded-xl p-4 md:p-6 bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">
              <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
              <ClipboardList className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 relative z-10" />
              <h3 className="text-white font-semibold text-base md:text-lg mb-1 relative z-10">Self Tasks</h3>
              <p className="text-purple-100 text-xs md:text-sm relative z-10">Log your own tasks & activities</p>
              <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-white absolute bottom-3 md:bottom-4 right-3 md:right-4 group-hover:translate-x-1 transition-transform duration-300" />
            </div>
          </Link>

          <Link href="/leaves" className="group touch-target">
            <div className="relative overflow-hidden rounded-xl p-4 md:p-6 bg-gradient-to-br from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">
              <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
              <Calendar className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 relative z-10" />
              <h3 className="text-white font-semibold text-base md:text-lg mb-1 relative z-10">Leave Request</h3>
              <p className="text-amber-100 text-xs md:text-sm relative z-10">Request time off & track leaves</p>
              <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-white absolute bottom-3 md:bottom-4 right-3 md:right-4 group-hover:translate-x-1 transition-transform duration-300" />
            </div>
          </Link>

          {/* CEO-specific actions - Mobile Optimized */}
          {isCEO && (
            <>
              <Link href="/admin?tab=create-task" className="group touch-target">
                <div className="relative overflow-hidden rounded-xl p-4 md:p-6 bg-gradient-to-br from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
                  <Plus className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 relative z-10" />
                  <h3 className="text-white font-semibold text-base md:text-lg mb-1 relative z-10">Assign Task</h3>
                  <p className="text-emerald-100 text-xs md:text-sm relative z-10">Create & assign tasks to team</p>
                  <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-white absolute bottom-3 md:bottom-4 right-3 md:right-4 group-hover:translate-x-1 transition-transform duration-300" />
                </div>
              </Link>

              <Link href="/admin?tab=employees" className="group touch-target">
                <div className="relative overflow-hidden rounded-xl p-4 md:p-6 bg-gradient-to-br from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
                  <Users className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 relative z-10" />
                  <h3 className="text-white font-semibold text-base md:text-lg mb-1 relative z-10">Team Management</h3>
                  <p className="text-indigo-100 text-xs md:text-sm relative z-10">Manage employees & roles</p>
                  <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-white absolute bottom-3 md:bottom-4 right-3 md:right-4 group-hover:translate-x-1 transition-transform duration-300" />
                </div>
              </Link>

              <Link href="/reports" className="group touch-target">
                <div className="relative overflow-hidden rounded-xl p-4 md:p-6 bg-gradient-to-br from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
                  <BarChart3 className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 relative z-10" />
                  <h3 className="text-white font-semibold text-base md:text-lg mb-1 relative z-10">Analytics</h3>
                  <p className="text-rose-100 text-xs md:text-sm relative z-10">View reports & insights</p>
                  <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-white absolute bottom-3 md:bottom-4 right-3 md:right-4 group-hover:translate-x-1 transition-transform duration-300" />
                </div>
              </Link>
            </>
